...
./flow --model cfg/yolov2-car.cfg --load bin/yolov2.weights --train --annotation VOCdevkit/VOC2007/FilteredAnnotations --dataset VOCdevkit/VOC2007/JPEGImages --gpu 1
